...
package com.mycompany.studentlistv;
import java.util.Scanner;
import java.util.Map;
import java.util.HashMap;

public class StudentListV {
    public static void main(String[] args) {
        Scanner input = new Scanner(System.in);
        Map<String, String> students = new HashMap<>();
        System.out.println("Enter three classmates' student number and first name:");
        for (int i = 0; i < 3; i++) {
        ...
        String name = input.nextLine();
        students.put(number, name);
        System.out.println("The entries in separate lines are:");
        for (Map.Entry<String, String> entry : students.entrySet()) {
            System.out.println(entry.getKey() + " " + entry.getValue());
        }
    }
